<?php $__env->startComponent('telescope-toolbar::item', ['name' => 'ajax']); ?>
    ...
    <?php $__env->slot('icon'); ?>
        ...
        <?php echo file_get_contents('/Users/richardjacobsen/development/rj-app/vendor/fruitcake/laravel-telescope-toolbar/resources/icons/' . basename('ajax') . '.svg'); ?>
...
<?php endif; ?>
<?php echo $__env->renderComponent(); ?><?php /**PATH /Users/richardjacobsen/development/rj-app/vendor/fruitcake/laravel-telescope-toolbar/src/../resources/views/collectors/ajax.blade.php ENDPATH**/ ?>