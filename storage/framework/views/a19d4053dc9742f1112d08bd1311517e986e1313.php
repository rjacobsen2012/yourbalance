...
<div id="sfMiniToolbar-<?php echo e($token); ?>" class="sf-minitoolbar" data-no-turbolink>
    <a class="open-button" href="#" title="Show Telescope toolbar" tabindex="-1" id="sfToolbarMiniToggler-<?php echo e($token); ?>" accesskey="D">
        <?php echo file_get_contents('/Users/richardjacobsen/development/rj-app/vendor/fruitcake/laravel-telescope-toolbar/resources/icons/' . basename('telescope') . '.svg'); ?>
    </a>
</div>
...
<!-- END of Laravel Telescope Toolbar --><?php /**PATH /Users/richardjacobsen/development/rj-app/vendor/fruitcake/laravel-telescope-toolbar/src/../resources/views/toolbar.blade.php ENDPATH**/ ?>